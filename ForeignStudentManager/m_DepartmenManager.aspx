<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="m_DepartmenManager.aspx.cs" Inherits="ForeignStudentManager.m_DepartmenManager" %>
...
<body>
    ...
    <br />
    <div id="DepartmentInsert" runat="server" style="margin-top:20px;" visible="false">
        <table border="1" cellspacing="4"  cellpadding="0"  rules="all" style="width: 488px; height: 111px;color:#333333;border-collapse:collapse;" >
            <tr>
               ...
               <asp:TextBox ID="txtDepartmentID" style="margin-left:10px;" runat="server" Width="200px"></asp:TextBox>
               </td>
            </tr>
                        <tr>
               <td width="30%" style="text-align:right;">
               ...
               <asp:TextBox ID="txtName" style="margin-left:10px;" runat="server" Width="200px"></asp:TextBox>
               </td>
            </tr>
                        <tr>
               <td width="30%" style="text-align:right;">
    ...
    <asp:GridView ID="grdDepartment" runat="server" AutoGenerateColumns="False" 
        CellPadding="4" DataKeyNames="DepartmentID" DataSourceID="SqlDataSource1" 
        ForeColor="#333333" Height="170px" 
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        InsertCommand="INSERT INTO [Department] ([DepartmentID], [Department]) VALUES (@DepartmentID, @Department)" 
        SelectCommand="SELECT * FROM [Department]" 
        UpdateCommand="UPDATE [Department] SET [Department] = @Department WHERE [DepartmentID] = @DepartmentID">
        <DeleteParameters>
