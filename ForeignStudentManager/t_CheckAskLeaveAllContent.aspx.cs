...
{
    public partial class t_CheckAskLeaveAllContent : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request["LeaveID"] != null)
            {
                ...
                string strSQL = string.Format("select PassportName,ChineseName from StudentBaseInfo where StudentID=(select StudentID from StudentLeaveInfo where StuLeaveID={0});", LeaveID);
        ...
        {
            Response.Redirect("t_CheckStudentAskLeave.aspx");
        }
    }
}